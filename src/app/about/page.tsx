  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 max-w-3xl mx-auto px-4 py-12">
        <h1 className="text-3xl font-bold mb-6">About RecallGuard</h1>

        <div className="space-y-6 text-muted leading-relaxed">
          <p>
            RecallGuard is a unified search engine for product recalls across
          ...
          <p>
            RecallGuard automatically ingests recall data from official
          ...
          <p>
            RecallGuard is not affiliated with any government agency. All recall
