    ...
    <div className="overflow-hidden rounded-lg border border-gray-200 bg-white shadow-sm">
      <div className="space-y-3 p-3 md:hidden">
        {permits.map((permit) => {
          ...
          return (
            <article key={permit.id} aria-labelledby={headingId} className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm">
              ...
              <h3 id={headingId} className="text-base font-semibold text-gray-900">{permit.address}</h3>
